...
it('Should be able to filter by arrival status', () => {
  ...
  PageObjects.FrontDesk.clickFilterByArrivalStatus();

  PageObjects.FrontDesk.selectArrivalStatus('No Show');
...
it('Should be able to filter by cleaning status', () => {
  ...
  PageObjects.FrontDesk.clickCleaningStatusArrival();

  PageObjects.FrontDesk.selectCleaningStatus(1)
